...
Phlexible.problems.portlet.Problems = Ext.extend(Ext.ux.Portlet, {
    ...
    initComponent: function () {
        this.tpl = new Ext.XTemplate(
            ...
            '<div class="m-problems-icon {iconCls}"></div>',
            '<div class="m-problems-severity m-problems-severity_{severity}-icon" ></div>',
            '<div class="m-problems-text">',
            '<span class="m-problems-message">{msg}</span>',
            '<tpl if="hint">',
            '<br />',
            '<span class="m-problems-solve">' + this.strings.solution + ': {hint}</span>',
            '</tpl>',
            '</div>',
