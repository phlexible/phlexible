...
class MenuLoader
{
     ...
     */
    public function __construct(EditableDiscovery $puliDiscovery, EventDispatcherInterface $dispatcher)
    {
    ...
    public function load()
    {
        ...
        foreach ($this->puliDiscovery->findBindings('phlexible/menu') as $binding) {
