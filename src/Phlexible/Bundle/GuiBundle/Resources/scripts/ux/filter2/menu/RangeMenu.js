...
Ext.provide('Ext.menu.RangeMenu');
...
Ext.extend(Ext.menu.RangeMenu, Ext.menu.Menu, {
    ...
    updateBuffer: 500,
    icons: {
        gt: Phlexible.inlineIcon('p-gui-greater_then-icon'),
        lt: Phlexible.inlineIcon('p-gui-less_then-icon'),
        eq: Phlexible.inlineIcon('p-gui-equals-icon')
    },
