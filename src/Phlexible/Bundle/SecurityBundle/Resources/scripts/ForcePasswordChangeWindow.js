...
Phlexible.security.ForcePasswordChangeWindow = Ext.extend(Ext.Window, {
    ...
    height: 370,
    layout: 'border',
    cls: 'p-users-forcepasswordchange-window',
...
//            iconCls: 'p-auth-login-icon',
        ...
        Phlexible.security.ForcePasswordChangeWindow.superclass.initComponent.call(this);
    },
