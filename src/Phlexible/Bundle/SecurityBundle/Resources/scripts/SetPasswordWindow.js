...
Phlexible.security.SetPasswordWindow = Ext.extend(Ext.Window, {
        ...
        this.items = [
            {
                ...
                html: '<img src="' + Phlexible.componentsPath + '/asset/images/logo.gif" width="300" height="120" style="padding-top: 15px" />'
            },
            {
                region: 'center',
                xtype: 'form',
                ...
                items: [
                    {
                        ...
                        html: this.strings.enter_new_password
                    },
                    {
                        xtype: 'textfield',
                        width: 150,
                    ...
                    },
                    {
                        ...
                        validator: function () {
                            ...
                            return p.getComponent(1).getValue() === p.getComponent(2).getValue();
                        }.createDelegate(this)
                    },
                    {
                        html: this.strings.set_ok,
...
//            iconCls: 'p-auth-login-icon',
        ...
        Phlexible.security.SetPasswordWindow.superclass.initComponent.call(this);
    },
    ...
    submit: function () {
        this.getComponent(1).form.submit({
            ...
            success: function (form, action) {
                ...
                this.getComponent(1).getComponent(2).disable();
                this.getComponent(1).getComponent(3).show();
            },
