...
class SiterootAssetProvider implements AssetProviderInterface
{
    ...
    public function getScriptsCollection()
    {
        $collection = new AssetCollection(array(
            ...
            new FileAsset($this->locator->locate('@PhlexibleSiterootBundle/Resources/scripts/SiterootNavigationWindow.js')),
            new FileAsset($this->locator->locate('@PhlexibleSiterootBundle/Resources/scripts/NavigationFlagsWindow.js')),
            ...
            new FileAsset($this->locator->locate('@PhlexibleSiterootBundle/Resources/scripts/menuhandle/SiterootsHandle.js')),
        ));
