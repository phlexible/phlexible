 ...
 * @copyright   2007 brainbits GmbH (http://www.brainbits.net)
 */
class Makeweb_Teasers_Event_HideInheritedTeaser extends Makeweb_Teasers_Event_BeforeHideInheritedTeaser
{
    /**
     * @var string
     */
    protected $_notificationName = Makeweb_Teasers_Event::HIDE_INHERITED_TEASER;
