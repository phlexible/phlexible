Ext.provide('Phlexible.mediamanager.MetaGrid');

Ext.require('Phlexible.metasets.util.Fields');
Ext.require('Phlexible.gui.grid.TypeColumnModel');

Phlexible.mediamanager.MetaGrid = Ext.extend(Ext.grid.EditorGridPanel, {
    ...
    initComponent: function () {
        ...
        Phlexible.mediamanager.MetaGrid.superclass.initComponent.call(this);
