...
//                asset_type: Phlexible.mediamanager.FLASH,
                file_view: 'medium',
...
//            disableButton.on('click', this.onDisable, this);
            ...
            this.emptyAddButton = fileBoxImageContainer.createChild({
                tag: 'span',
                cls: 'AddText',
                html: Phlexible.mediamanager.Strings.click_to_add_flash
            });
...
//                cls: 'FileBoxLegend'
//            });
//            this.createTable(this.videotemplates);
            this.el.createChild({
                tag: 'div',
...
Ext.reg('flashfilefield', Ext.form.FlashFileField);
