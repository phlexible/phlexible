            ...
            'data'   => array(
                DB_PREFIX . 'mediamanager_site' => array(
                    array(
                        ...
                        'root_dir'    => /*DATA_DIR . */'mediamanager/',
                        'quota'       => 10000000000,
                ...
                DB_PREFIX . 'mediamanager_folders' => array(
                    array(
                        'id'             => $rootID = Brainbits_Util_Uuid::generate(),
                        'parent_id'      => null,
                ...
                DB_PREFIX . 'mediamanager_folder_rights' => array(
                    array(
                        'folder_id'      => $rootID,
                        'object_type'    => 'group',
                        'object_id'      => $db = MWF_Registry::getContainer()->dbPool->default->fetchOne($db = MWF_Registry::getContainer()->dbPool->default->select()->from(DB_PREFIX . 'group', 'gid')->where('name = ?', 'everyone')->limit(1)),
                        'folder_read'    => 1,
                        'folder_create'  => 1,
                        'folder_modify'  => 1,
                        'folder_delete'  => 1,
