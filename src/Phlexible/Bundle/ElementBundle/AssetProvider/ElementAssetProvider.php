...
class ElementAssetProvider implements AssetProviderInterface
{
    ...
    public function getScriptsCollection()
    {
        $collection = new AssetCollection(array(
            ...
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/CatchDataPanel.js')),
            ...
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/ElementLayoutTree.js')),
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/ElementLayoutPanel.js')),
            ...
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/NewTeaserWindow.js')),
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/NewTeaserInstanceWindow.js')),
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/NewCatchWindow.js')),
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/PublishTreeNodeWindow.js')),
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/PublishTeaserWindow.js')),
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/SetTreeNodeOfflineWindow.js')),
            new FileAsset($this->locator->locate('@PhlexibleElementBundle/Resources/scripts/SetTeaserOfflineWindow.js')),
