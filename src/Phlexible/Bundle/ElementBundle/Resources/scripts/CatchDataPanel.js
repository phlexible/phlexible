Phlexible.elements.CatchDataPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    labelSeparator: '',
                    element: {
                        siteroot_id: this.lockElement.siteroot_id
                    },
                    recursive: true,
                    width: 300,
                    listWidth: 300,
                ...
                items: [{
                    ...
                    store: new Ext.data.SimpleStore({
                        fields: ['title', 'value'],
                        data: [[Phlexible.elements.Strings.ascending, 'ASC'], [Phlexible.elements.Strings.descending, 'DESC']]
                    }),
                    value: 'ASC',
                    displayField: 'title',
                    valueField: 'value',
        ...
        var lockStatus = this.lockElement.getLockStatus();

        this.tbar = [{
            text: this.strings.save_element,
            iconCls: 'p-element-save-icon',
            disabled: lockStatus != 'edit',
    ...
    submitForm: function() {
        ...
        if (form.isValid()) {
            form.submit({
                url: Phlexible.Router.generate('teasers_layout_savecatch'),
                params: {
                    id: this.catchId
                },
