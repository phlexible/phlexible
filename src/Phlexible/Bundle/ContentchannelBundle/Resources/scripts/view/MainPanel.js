Ext.provide('Phlexible.contentchannels.MainPanel');
Ext.require('Phlexible.contentchannels.ContentchannelForm');
Ext.require('Phlexible.contentchannels.ContentchannelsGrid');
