Phlexible.elementtypes.ElementtypeStructureTreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    ...
    applyNodeConfigToText: function(n, text) {
        if (n.attributes.type == 'group' || n.attributes.type == 'accordion' && n.attributes.properties && n.attributes.properties.configuration) {
            ...
            if (isOptional) {
                text += '<img qtip="Is optional" src="'+Phlexible.component('/elementtypes/images/is_optional.png')+'" width="15" height="15" style="vertical-align: middle;" />';
            }
            if (isRepeatable) {
                text += '<img qtip="Is repeatable" src="'+Phlexible.component('/elementtypes/images/is_repeatable.png')+'" width="15" height="15" style="vertical-align: middle;" />';
            }
            if (isSingleLine) {
                text += '<img qtip="Is single line" src="'+Phlexible.component('/elementtypes/images/is_singleline.png')+'" width="15" height="15" style="vertical-align: middle;" />';
            }
            if (isSortable) {
                text += '<img qtip="Children are sortable" src="'+Phlexible.component('/elementtypes/images/is_sortable.png')+'" width="15" height="15" style="vertical-align: middle;" />';
            }
        }
        else {
            if (n.attributes.properties && n.attributes.properties.configuration) {
                ...
                if (isSynchronized) {
                    text += '<img qtip="Is synchronized" src="' + Phlexible.component('/elementtypes/images/is_synchronized.png')+'" width="15" height="15" style="vertical-align: middle;" />';
                }
            }
        }
