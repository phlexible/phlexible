Phlexible.frontendmedia.VideoFileField = Ext.extend(Ext.form.VideoFileField, {
    // private
    onRender: function (ct, position) {
        Phlexible.frontendmedia.VideoFileField.superclass.onRender.call(this, ct, position);
...
Ext.reg('frontendmedia-field-videofilefield', Phlexible.frontendmedia.VideoFileField);

Phlexible.fields.Registry.addFactory('video', function (parentConfig, item, valueStructure, pos, element, repeatablePostfix, forceAdd) {
    if (element.master) {
    ...
    Ext.apply(config, {
        xtype: 'frontendmedia-field-videofilefield',
...
Phlexible.fields.FieldTypes.addField('video', {
    titles: {
        de: 'Video',
        en: 'Video'
    },
    iconCls: 'p-frontendmedia-field_video-icon',
    allowedIn: [
        'tab',
        'accordion',
        'group',
